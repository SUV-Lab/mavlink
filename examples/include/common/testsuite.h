...
static void mavlink_test_monitoring(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_monitoring_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.ready = packet_in.ready;
        packet1.battery = packet_in.battery;
        packet1.safety = packet_in.safety;
    ...
    mavlink_msg_monitoring_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_monitoring_pack(system_id, component_id, &msg , packet1.ready , packet1.battery , packet1.safety );
    mavlink_msg_monitoring_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_monitoring_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ready , packet1.battery , packet1.safety );
    mavlink_msg_monitoring_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_monitoring_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_monitoring_send(MAVLINK_COMM_1 , packet1.ready , packet1.battery , packet1.safety );
    mavlink_msg_monitoring_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
